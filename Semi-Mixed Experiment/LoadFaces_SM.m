function [pictureBlock, nbPicturesLoaded, destinationRect,fileNum] = LoadFaces_SM(folderToLoadFrom,folderToLoadFrom2,folderToLoadFrom3, nbFilesExpected, win, rescaleRatio,samef)
...
if samef==3
    folderToLoadFrom3 = fullfile(folderToLoadFrom3);
end
...
if samef==3
    listing3 = dir([folderToLoadFrom3,'/*.bmp']);
...
for idx = 1:200
    ...
    if samef==2
     ...
     if samef==3
        dotPos3 = strfind(fileName3, '.');
        dotPos3 = dotPos3(1);
        fileNum3(idx) = str2num(fileName3(4 : dotPos3 - 1));
        % Concatenate path with name
        filePath3 = fullfile(folderToLoadFrom3, fileName3);
        
        % Reads the file
        theImage3 = imread(filePath3);
    end
    ...
    imagedouble(1:768,1:412,:) = theImage; %512
    if samef==2
    ...
    if samef==3
        imagedouble(1:768,1813:2324,:)=theImage3;
    else
        imagedouble(1:768,1813:2324,:)=theImage;
    end
